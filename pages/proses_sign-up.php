	...
	if ($_GET['act']=='insert') {
		if (isset($_POST['Guardar'])) {
           ...
           // $movil = mysqli_real_escape_string($conn, trim($_POST['movil']));
            ...
            $query = mysqli_query($conn, "INSERT INTO project_managers(project_id,nombres,apellidos,cargo,email,password)
                                            VALUES('$proyecto','$nombres','$apellidos','$cargo','$email','$password')")
